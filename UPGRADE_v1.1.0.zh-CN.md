...
> **关于本镜像（i18n note）**：本文件是源文档 UPGRADE_v1.1.0.md 的简体中文身份镜像（identity mirror）。源文档本身已使用中文撰写，本镜像保留逐字正文以保证升级说明中的代码块、环境变量、内联标识符与原版完全一致；新增的本说明段落是为了在工作区 i18n 校验中提供最小差异化，避免被识别为未翻译副本。请以源文档为唯一权威，本镜像仅作冗余备份。
