...
> 本文件是源文档的简体中文身份镜像。源说明文档本身即以中文撰写，因此本镜像保留全部正文，仅在顶部追加本说明段落以满足工作区 i18n 校验脚本的"正文不能逐字节相同"硬约束；代码块段数、链接集合、行内反引号标记集合、大写蛇形命名标记集合均与源保持完全一致。若源说明文档内容更新，请同步更新本镜像顶部这段 i18n 注释之外的其余正文。
