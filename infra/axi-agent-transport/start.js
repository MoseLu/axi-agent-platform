...
;(function bootstrap() {
  ...
  if (!fs.existsSync(path.join(__dirname, 'node_modules'))) {
    ...
    require('child_process').execSync('pnpm install', { cwd: __dirname, stdio: 'inherit' });
...
/**
 * start.js — Entry point for the Axi Agent Transport
 *
 * Usage:
...
console.log('');
console.log('  ╔══════════════════════════════════════════╗');
console.log('  ║       Axi Agent Transport        ║');
console.log('  ╚══════════════════════════════════════════╝');
